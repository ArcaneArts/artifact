...
_2 _S = [
  ...
  'defX',
  'finalDefX',
  'Missing required AllFields."finalX" in map ',
];
const bool _T = true;
const bool _F = false;
const _5 _ = 0;
...
extension $AllFields on _6 {
  ...
  _6 copyWith({
    ...
    finalX:
        deltaFinalX != null
            ? (finalX ?? _t.finalX) + deltaFinalX
            : finalX ?? _t.finalX,
    nullX:
        deltaNullX != null
            ? (nullX ?? _t.nullX ?? 0) + deltaNullX
            : deleteNullX
            ? null
            : (nullX ?? _t.nullX),
    defX:
        deltaDefX != null
            ? (defX ?? _t.defX ?? 0) + deltaDefX
            : deleteDefX
            ? null
            : resetDefX
            ? 4
    ...
    finalDefX:
        deltaFinalDefX != null
            ? (finalDefX ?? _t.finalDefX) + deltaFinalDefX
            : resetFinalDefX
            ? 99
            : (finalDefX ?? _t.finalDefX),
  );
}
