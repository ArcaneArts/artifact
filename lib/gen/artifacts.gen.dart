...
extension $NullableReflectSubObject on NullableReflectSubObject{
  ...
  ArtifactMirror get $mirror{_;return ArtifactReflection.instanceOf(_H)!;}
  static List<Object> get $annotations {_;return[Artifact(generateSchema: _F,compression: _F,reflection: _T),];}
  static List<$AFld> get $fields{_;return[$AFld<NullableReflectSubObject, String>('value',(i)=>i.value,(i,v)=>i.copyWith(value:v),[],),$AFld<NullableReflectSubObject, int>('anotherValue',(i)=>i.anotherValue,(i,v)=>i.copyWith(anotherValue:v),[],),];}
  static List<$AMth> get $methods {_;return[];}
}
extension $NullableReflectCollectionsModel on NullableReflectCollectionsModel{
  ...
  ArtifactMirror get $mirror{_;return ArtifactReflection.instanceOf(_H)!;}
  static List<Object> get $annotations {_;return[Artifact(generateSchema: _F,compression: _F,reflection: _T),];}
  static List<$AFld> get $fields{_;return[$AFld<NullableReflectCollectionsModel, List<String?>>('aListOfNullableStrings',(i)=>i.aListOfNullableStrings,(i,v)=>i.copyWith(aListOfNullableStrings:v),[],),$AFld<NullableReflectCollectionsModel, Set<String?>>('aSetOfNullableStrings',(i)=>i.aSetOfNullableStrings,(i,v)=>i.copyWith(aSetOfNullableStrings:v),[],),$AFld<NullableReflectCollectionsModel, List<NullableReflectSubObject?>>('aListOfNullableSubObjects',(i)=>i.aListOfNullableSubObjects,(i,v)=>i.copyWith(aListOfNullableSubObjects:v),[],),$AFld<NullableReflectCollectionsModel, Set<NullableReflectSubObject?>>('aSetOfNullableSubObjects',(i)=>i.aSetOfNullableSubObjects,(i,v)=>i.copyWith(aSetOfNullableSubObjects:v),[],),$AFld<NullableReflectCollectionsModel, Map<String, String?>>('aMapOfStringToNullableString',(i)=>i.aMapOfStringToNullableString,(i,v)=>i.copyWith(aMapOfStringToNullableString:v),[],),$AFld<NullableReflectCollectionsModel, Map<String, NullableReflectSubObject?>>('aMapOfStringToNullableSubObject',(i)=>i.aMapOfStringToNullableSubObject,(i,v)=>i.copyWith(aMapOfStringToNullableSubObject:v),[],),];}
  static List<$AMth> get $methods {_;return[];}
}
