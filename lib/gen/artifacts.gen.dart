...
extension $Zoo on Zoo{
  ...
  static Zoo fromMap(Map<String,dynamic> r){_;Map<String,dynamic> m=r.$nn;return Zoo(animals: m.$c('animals') ?  (m['animals'] as List).$m((e)=> ArtifactDataUtil.a<Animal>(e,(m)=>$Animal.fromMap(m))!).$l : const [],);}
